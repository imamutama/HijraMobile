...
import controller.OnBoarding.Register.EndProsesController;
import controller.OnBoarding.Register.PersonalInfoController;
...
public class PersonalInfoTest extends BaseTest {
    ...
    public void validationPendidikanNull(String validationPendidikan) throws IOException {
        personalInfoController = new PersonalInfoController(driver);
        personalInfoController
                .click_lanjut()
    ...
    @Test(priority = 14)
    @Severity(SeverityLevel.CRITICAL)
    @Description("Personal Info Success")
    @Story("HIJRA-293 [Android-FE] Personal Info - As a user, I want to fill out the additional information about my current state, so that I might use that data to access more financial products.")
    public void PersonalInfoSuccess() {
        personalInfoController = new PersonalInfoController(driver);
        personalInfoController
                .click_lanjut();
    }
