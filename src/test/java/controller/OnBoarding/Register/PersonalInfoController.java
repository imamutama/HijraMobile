...
import pages.OnBoarding.Register.PersonalInfoPage;
...
public class PersonalInfoController extends BaseController {
    ...
    public PersonalInfoController validation_informasi() {
        String textValidation = readText(personalInfoPage.getValidationInfomasiTambahan());
        System.out.println(textValidation);
        Assert.assertTrue(textValidation.equalsIgnoreCase("Info pekerjaan dan keuangan"));
        return this;
    }
