...
import Mobile.controller.OnBoarding.Register.UploadDocumentController;
...
public class UploadDocumentTest extends BaseTest {
    ...
    public void continueUpload() throws Exception {
    ...
    public void noKtpNull(String validationKtpNull) throws Exception {
        documentController = new UploadDocumentController(driver);
        documentController
    ...
    public void DateNull(String validationDateNull) throws Exception {
        documentController = new UploadDocumentController(driver);
        documentController
                .input_nama(variableProperties.getNameKtp())
                .click_gunakan()
