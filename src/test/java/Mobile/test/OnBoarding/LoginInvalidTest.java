...
public class LoginInvalidTest extends BaseTest {
    ...
    public void loginNull(String validationLoginNull) throws Exception {
    ...
    public void hijraIDNull(String validationHijraNull) throws Exception {
        loginController = new LoginController(driver);
        loginController
    ...
    public void passwordNull(String validationPassNull) throws Exception {
        loginController = new LoginController(driver);
        loginController
