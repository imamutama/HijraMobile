...
public class SubmitSignaturePost extends BaseTest {
    @BeforeClass
    void submitSignaturePost() throws IOException, JSONException {
        ...
        response = httpRequest.request(Method.POST, "/onboarding/signature");
