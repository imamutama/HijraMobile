...
public class SubmitSelfiePost extends BaseTest {


    @BeforeClass
    void submitSelfie() throws IOException, JSONException {
        ...
        File file1_new2 = new File(System.getProperty("user.dir")+"//filejson//selfie.txt");
        httpRequest.multiPart("username", file1_new2);
        httpRequest.multiPart("image", file1_new1, "image/jpeg");
        response = httpRequest.request(Method.POST, "/onboarding/selfie");
