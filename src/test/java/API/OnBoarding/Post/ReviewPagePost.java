...
public class ReviewPagePost extends BaseTest {
    ...
    void reviewPage() throws IOException, JSONException {
        ...
        try {
            requestParams = FileUtils.readFileToString(new File(System.getProperty("user.dir")+"//filejson//reviewPage.json"), StandardCharsets.UTF_8);
        ...
        response = httpRequest.request(Method.POST, "/onboarding/review-data");
